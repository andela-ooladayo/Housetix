...
ApplicationConfiguration.registerModule('accomodations');'use strict';
// Use Applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('core');'use strict';
// Use Applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('users');'use strict';
// Configuring the A module
angular.module('accomodations').run([
  'Menus',
  function (Menus) {
...
//Setting up route
angular.module('accomodations').config([
  '$stateProvider',
  function ($stateProvider) {
    // Accomodations state routing
    $stateProvider.state('listAccomodations', {
      url: '/accomodations',
...
angular.module('accomodations').controller('AccomodationsController', [
  '$scope',
  '$stateParams',
  '$location',
  '$upload',
  ...
  function ($scope, $stateParams, $location, $upload, Authentication, Accomodations, Agent, Photo) {
    ...
    $scope.find = function () {
      Accomodations.query(function success(response) {
    ...
    $scope.findOne = function () {
      $scope.accomodation = Accomodations.get({ accomodationId: $stateParams.accomodationId }), function (response) {
        $scope.photos = $scope.accomodation.image;
      };
    };
    //List accomodation by Current User
    $scope.profile = function () {
      Agent.query(function success(response) {
      });
    };
  }
]);'use strict';
//Accomodations service used for communicating with the accomodations REST endpoints
angular.module('accomodations').factory('Accomodations', [
  '$resource',
  function ($resource) {
    return $resource('accomodations/:accomodationId', { accomodationId: '@_id' }, { update: { method: 'PUT' } });
  }
]).factory('Search', [
  '$resource',
  function ($resource) {
  ...
  '$resource',
  function ($resource) {
    return $resource('users/accomodation', { update: { method: 'PUT' } });
  }
]).factory('Photo', [
  '$resource',
  function ($resource) {
    return $resource('/accomodations/:accomodationId/editPhoto', { accomodationId: '@accomodationId' }, { update: { method: 'PUT' } });
  }
]);'use strict';
// Setting up route
...
// Modal Controller
angular.module('users').controller('ModalDemoCtrl', [
  '$scope',
  '$location',
  '$modal',
  '$log',
...
angular.module('users').controller('ModalInstanceCtrl', [
  '$scope',
  '$location',
  '$modalInstance',
  'items',
  function ($scope, $location, $modalInstance, items) {
    $scope.items = items;
...
angular.module('core').controller('HomeController', [
  ...
  function ($scope, Authentication, $location, Search, $anchorScroll) {
    ...
    $scope.nearSearch = function (locate) {
      $scope.locate = locate;
      Search.query({ location: $scope.locate }, function (reply) {
        console.log(reply);
    ...
    $scope.search = function () {
      Search.query({ location: $scope.inputBox.toLowerCase() }, function (response) {
